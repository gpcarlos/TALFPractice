...
\newpage
      ...
      \begin{tikzpicture}[shorten >=1pt,node distance=2cm,auto]
        ...
        \node[state,invisible]  (I01)             { }; % E7
        \node[state]  (Q15) [left of=I01]         {3};
        \node[state]  (Q09) [above of=I01]        {4};
        \node[state]  (Q10) [right of=Q09]        {5};
        \node[state]  (Q11) [right of=Q10]        {6};
        \node[state]  (Q12) [right of=Q11]        {7};
        \node[state]  (Q13) [right of=Q12]        {8};
        \node[state]  (Q14) [right of=Q13]        {9};
        \node[state]  (Q01) [below of=I01]        {10};
        \node[state]  (Q02) [right of=Q01]        {11};
        \node[state]  (Q03) [right of=Q02]        {12};
        \node[state]  (Q04) [right of=Q03]        {13};
        \node[state]  (Q05) [right of=Q04]        {14};
        \node[state]  (Q06) [right of=Q05]        {15};
        \node[state]  (Q07) [right of=Q06]        {16};
        \node[state]  (Q08) [right of=Q07]        {17};
        \node[state,invisible]  (I02) [above of=Q08] { };
        \node[state]  (Q16) [right of=I02]        {18};
        \node[state]  (Q17) [right of=Q16]        {19};
        \node[state]  (Q18) [right of=Q17]        {20};
        \node[state]  (Q19) [right of=Q18]        {21};
        \node[state]  (Q20) [right of=Q19]        {22};

        \node[state,invisible]  (I05) [below of=Q15] { };
        \node[state,invisible]  (I06) [below of=I05] { };
        \node[state,invisible]  (I07) [below of=I06] { };
        \node[state]  (Q41) [left of=I06]        {3};

        \node[state]  (Q21) [below of=I07]        {23};
        \node[state,invisible]  (I03) [right of=Q21] { }; % E8
        \node[state]  (Q22) [above of=I03]        {24};
        \node[state]  (Q23) [right of=Q22]        {25};
        \node[state]  (Q24) [right of=Q23]        {26};
        \node[state]  (Q25) [right of=Q24]        {27};
        \node[state]  (Q26) [right of=Q25]        {28};
        \node[state]  (Q27) [right of=Q26]        {29};
        \node[state]  (Q28) [below of=I03]        {30};
        \node[state]  (Q29) [right of=Q28]        {31};
        \node[state]  (Q30) [right of=Q29]        {32};
        \node[state]  (Q31) [right of=Q30]        {33};
        \node[state]  (Q32) [right of=Q31]        {34};
        \node[state]  (Q33) [right of=Q32]        {35};
        \node[state]  (Q34) [right of=Q33]        {36};
        \node[state]  (Q35) [right of=Q34]        {37};
        \node[state,invisible]  (I04) [above of=Q35] { };
        \node[state]  (Q36) [right of=I04]        {38};
        \node[state]  (Q37) [right of=Q36]        {39};
        \node[state]  (Q38) [right of=Q37]        {40};
        \node[state]  (Q39) [right of=Q38]        {41};
        \node[state]  (Q40) [right of=Q39]        {42};

        \node[state,invisible]  (I08) [below of=Q20] { };
        \node[state,invisible]  (I09) [below of=I08] { };
        \node[state]  (Q42) [right of=I09] {43};

        \node[state,accepting]  (Q43) [right of=Q42] {44};
        \node[state,initial]  (Q44) [left of=Q41] {1};

        \path[->]
                  (Q41) edge node                     {$\varepsilon$} (Q15)
                        edge node [swap]              {$\varepsilon$} (Q21)
                  (Q44) edge node                     {$\varepsilon$} (Q41)
                  (Q09) edge node                     {$\varepsilon$} (Q10)% E7
                        edge [bend right] node [swap] {$\varepsilon$} (Q14)
                  (Q10) edge node                     {0}             (Q11)
                  (Q11) edge node                     {$\varepsilon$} (Q12)
                  ...
                  (Q39) edge node                     {0}             (Q40)
                  (Q40) edge node [swap]              {$\varepsilon$} (Q42)
                  (Q42) edge node                     {$\varepsilon$} (Q43);
        \path[->][blue]
                  (Q44) edge [bend right] node        {$\varepsilon$} (Q43)
                  (Q43) edge [bend right] node        {$\varepsilon$} (Q44);
      \end{tikzpicture}
      \end{adjustbox}
      \end{center}
